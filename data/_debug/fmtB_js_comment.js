...
function funcToDayNewComment( argTouban , argOrder , argRacenum , argType )
{
	...
	if( strTouban === '2538'){
		...
		if( strOrder === '1'){
			if( intRaceNum >= 3){
				if( strType === '1' ){
					strComment = '今日は合っていなかった。初日の良くない状態に近い';
				}else if( strType === '2' ){
					strComment = '2';
				}else if( strType === '3' ){
					strComment = '3';
		...
		if( strOrder === '1'){
			if( intRaceNum >= 5){
				if( strType === '1' ){
					strComment = '良かった時が『８点』だとすれば今は『６点』くらい。';
				}else if( strType === '2' ){
					strComment = '2';
				}else if( strType === '3' ){
					strComment = '5';
		...
		if( strOrder === '1'){
			if( intRaceNum >= 2){
				if( strType === '1' ){
					strComment = '乗り心地とアシのバランスを取る調整でいってみる';
				}else if( strType === '2' ){
					strComment = '2';
				}else if( strType === '3' ){
					strComment = '2';
		...
		if( strOrder === '1'){
			if( intRaceNum >= 1){
				if( strType === '1' ){
					strComment = '昨日の方が良かった。今日は本当に中堅になってしまった。';
				}else if( strType === '2' ){
					strComment = '2';
				}else if( strType === '3' ){
					strComment = '1';
		...
		if( strOrder === '1'){
			if( intRaceNum >= 4){
				if( strType === '1' ){
					strComment = '足併せでも回ってから少し余裕あったし出足は良い';
				}else if( strType === '2' ){
					strComment = '2';
				}else if( strType === '3' ){
					strComment = '4';
