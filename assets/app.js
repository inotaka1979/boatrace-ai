  ...
  function openRace(sid, rn) {
    ...
    if (result && result.isFinished && result.results && result.results.length > 0) {
      ...
      if (pred && places.length >= 3) {
        ...
        var banner = hit && anaHit ? "3\u9023\u5358 \u7684\u4E2D! \uFF0B \u{1F525}\u7A74\u4E88\u60F3 \u7684\u4E2D!" : hit ? "3\u9023\u5358 \u7684\u4E2D!" : anaHit ? "\u{1F525}\u7A74\u4E88\u60F3 \u7684\u4E2D!" : "\u4E0D\u7684\u4E2D";
        resHtml += '<div style="margin-top:8px;font-size:14px;font-weight:700;text-align:center" class="' + (hit || anaHit ? "hit" : "miss") + '">' + banner + "</div>";
